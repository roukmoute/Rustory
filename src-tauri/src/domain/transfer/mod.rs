...
pub use transfer::{
    ...
    ensure_cohort_coherent, failure_copy, pack_uuid_bytes, remove_pack_uuid, reorder_pack_index,
    short_id_from_pack_uuid, ChecksumProbe, PackWriteFile, PackWritePlan, ReorderIndexError,
    TransferCompleteness, TransferFailureCause, VerifiedSummary, VerifyVerdict, WriteOutcome,
};
