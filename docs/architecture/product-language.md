...
| Support profile screen — section headers | `Appareils` / `Artefacts locaux` / `Sources de contenu` / `Politique de distribution` | The four frozen `<h2>` of the support-profile screen, in this order | `Matrice`, `Devices`, `Flux`, `Légal` |
